...
public class Reparticiones implements Imprimible {
    ...
    /**
     * Retorna una lista con las IDs de todas las Reparticiones sin
     * Trabajadores.
     */
    public ArrayList<Integer> getIDsSinTrabajadores() {
        ...
        for (Reparticion r : reparticiones.values()) {
            if (!cs.getIDsByIdReparticion(r.getId()).isEmpty()) {
                continue;
            }
            list.add(r.getId());
        }
    ...
    /**
     * Retorna una lista de IDs de reparticion, conteniendo todas las que tengan
     * el mismo nombre, ignorando mayusculas.
     */
